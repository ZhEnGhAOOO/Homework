import { blog_front } from "../../declarations/blog_front";
...
async function load_posts(){
  ...
  let posts;
  if(flag == "myself"){
    posts = await blog_front.posts();
  }else{
    posts = await blog_front.posts_by_id(flag);
  }
...
async function load_follows(){
  ...
  follows = await blog_front.follows();
